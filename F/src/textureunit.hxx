...
{
  inline
  GLuint Unit::id() const
  {
    return _id;
  }

  inline
  GLuint Unit::width() const
  {
    return _width;
  }

  inline
  GLuint Unit::height() const
  {
    return _height;
  }

  inline
  GLuint Unit::renderWidth() const
  {
    return _renderWidth;
  }

  inline
  GLuint Unit::renderHeight() const
  {
  ...
  inline
  const unsigned char * Unit::data() const
  {
    return _data;
  }
  ...
  inline
  void Unit::setFormat(GLenum format)
  {
    _format = format;
  }
}
