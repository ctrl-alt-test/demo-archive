...
#define NUMFUNCIONES (3+5+1+0+5+14+1+12+14+1)
...
#define oglUniform3fv                  ((PFNGLUNIFORM3FVPROC)msys_oglfunc[22])
...
#define oglDrawBuffers                 ((PFNGLDRAWBUFFERSPROC)msys_oglfunc[40])

// shaders for CAT
#define oglGetShaderiv                 ((PFNGLGETSHADERIVPROC)msys_oglfunc[41])
#define oglGetProgramiv                ((PFNGLGETPROGRAMIVPROC)msys_oglfunc[42])
#define oglGetShaderInfoLog            ((PFNGLGETSHADERINFOLOGPROC)msys_oglfunc[43])
#define oglGetProgramInfoLog           ((PFNGLGETPROGRAMINFOLOGPROC)msys_oglfunc[44])
#define oglDeleteShader                ((PFNGLDELETESHADERPROC)msys_oglfunc[45])
#define oglDeleteProgram               ((PFNGLDELETEPROGRAMPROC)msys_oglfunc[46])
#define oglIsShader                    ((PFNGLISSHADERPROC)msys_oglfunc[47])
#define oglUniform3f                   ((PFNGLUNIFORM3FPROC)msys_oglfunc[48])
#define oglVertexAttribPointer         ((PFNGLVERTEXATTRIBPOINTERPROC)msys_oglfunc[49])
#define oglEnableVertexAttribArray     ((PFNGLENABLEVERTEXATTRIBARRAYPROC)msys_oglfunc[50])
#define oglDisableVertexAttribArray    ((PFNGLDISABLEVERTEXATTRIBARRAYPROC)msys_oglfunc[51])
#define oglGetAttribLocation           ((PFNGLGETATTRIBLOCATIONPROC)msys_oglfunc[52])
#define oglGenFramebuffersEXT          ((PFNGLGENFRAMEBUFFERSEXTPROC)msys_oglfunc[53])
#define oglUniform1f                   ((PFNGLUNIFORM1FPROC)msys_oglfunc[54])

// Attribs immediate mode
#define oglVertexAttrib3f              ((PFNGLVERTEXATTRIB3FPROC)msys_oglfunc[55])

// VBO
//#define oglGenBuffers                  ((PFNGLGENBUFFERSPROC)msys_oglfunc[56])
