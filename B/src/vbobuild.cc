...
namespace VBO
{
  ...
  unsigned int addCubeToChunk(VBO::vertex * dest, const vector3f &p,
			      float size,
			      ...
			      bool z1face, bool z2face)
  {
    ...
    for (unsigned int i = 0; i < Cube::numberOfVertices; ++i)
	  ...
	  (z2face && i >= 20))
      {
	dest[vertex] = Cube::vertices[i];
	VBO::vertex & dst = dest[vertex];
  ...
  unsigned int addCubeToChunk(VBO::vertex * dest, const float m[16],
			      const vector3f &color,
			      bool x1face, bool x2face,
			      bool y1face, bool y2face,
			      bool z1face, bool z2face)
  ...
  void addCube(Array<VBO::vertex> &vbo, const vector3f & pos, float size,
	       bool x1face, bool x2face,
	       bool y1face, bool y2face,
	       bool z1face, bool z2face)
  {
    ...
    VBO::vertex *ptr = vbo.elt + vbo.size;
  ...
  void addCube(Array<VBO::vertex> &vbo, const vector3f & pos,
	       const vector3f & color,
	       bool x1face, bool x2face,
	       bool y1face, bool y2face,
	       bool z1face, bool z2face)
  ...
  void addCube(Array<VBO::vertex> & vbo, const float m[16],
	       const vector3f & color,
	       bool x1face, bool x2face,
	       bool y1face, bool y2face,
	       bool z1face, bool z2face)
  ...
  // Si on veut reutiliser le code, qttention a la couleur aleatoire. :)
  void addFromRenderList(Array<VBO::vertex> & vbo,
