...
namespace Cube
{
  VBO::vertex vertices[] =
    {
      ...
      {-U, -U, -U,  -P, -N, -N,   0, 0,  P,  1.f, 1.f, 1.f,  0, 0},
      {-U, -U,  U,  -P, -N,  N,   0, 0,  P,  1.f, 1.f, 1.f,  T, 0},
      {-U,  U,  U,  -P,  N,  N,   0, 0,  P,  1.f, 1.f, 1.f,  T, T},
      {-U,  U, -U,  -P,  N, -N,   0, 0,  P,  1.f, 1.f, 1.f,  0, T},
      ...
      {-U, -U, -U,  -N, -P, -N,   P, 0,  0,  1.f, 1.f, 1.f,  0, 0},
      { U, -U, -U,   N, -P, -N,   P, 0,  0,  1.f, 1.f, 1.f,  T, 0},
      { U, -U,  U,   N, -P,  N,   P, 0,  0,  1.f, 1.f, 1.f,  T, T},
      {-U, -U,  U,  -N, -P,  N,   P, 0,  0,  1.f, 1.f, 1.f,  0, T},
      ...
      {-U, -U, -U,  -N, -N, -P,  -P, 0,  0,  1.f, 1.f, 1.f,  T, 0},
      {-U,  U, -U,  -N,  N, -P,  -P, 0,  0,  1.f, 1.f, 1.f,  T, T},
      { U,  U, -U,   N,  N, -P,  -P, 0,  0,  1.f, 1.f, 1.f,  0, T},
      { U, -U, -U,   N, -N, -P,  -P, 0,  0,  1.f, 1.f, 1.f,  0, 0},
  ...
  const unsigned int numberOfVertices = sizeof(vertices) / sizeof(VBO::vertex);
  const unsigned int numberOfVerticesPerFace = (sizeof(vertices) / sizeof(VBO::vertex)) / 6;
}
