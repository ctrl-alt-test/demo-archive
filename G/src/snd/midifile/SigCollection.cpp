...
template<class type>
void SigCollection<type>::allowGrowth(bool status) {
  this->allowGrowthQ = status;
}
...
//      int newAlloc = 1024;
//      if (2*newAlloc > newAlloc) newAlloc = 2*newSize;
//       this->grow(newAlloc-this->getAllocSize());
