...
class MidiFile {
   ...
   private:
      void       extractMidiData  (FileIO& inputfile, StaticArray<uchar>& array, 
      ...
      static int _cdecl ticksearch       (const void* A, const void* B);
      static int _cdecl secondsearch     (const void* A, const void* B);
